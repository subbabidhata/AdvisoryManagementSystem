...
<form name="getUserDetails" method="post" action="processUpdateApp_Delete.php">
<table class="table-style-three">
  ...
  <tr><td>Active:</td>            <td><input type="text" name="ashow" value="<?php print $details['ashow']; ?>"></td></tr>
